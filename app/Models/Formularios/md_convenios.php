<?php namespace App\Models\Formularios;
	...
	class md_convenios extends Model {
	    ...
	    protected $allowedFields = ['id', 'id_socio', 'id_servicio', 'detalle_servicio', 'fecha_servicio', 'numero_cuotas', 'fecha_pago', 'costo_servicio', 'estado', 'id_usuario', 'fecha', 'id_apr'];
