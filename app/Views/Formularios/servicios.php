<main>
    <div class="container-fluid">
        <h3 class="mt-4" align="center"><i class="fas fa-hammer"></i> Servicios</h3>
        ...
        <div class="container-fluid">
	        ...
	        <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                	<div class="card mb-4">
	                	...
	                	<div class="card shadow mb-12 collapse" id="datosServicio">
				            <div class="card-body">
				            	<div class="container-fluid">
			...
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                	<div class="card mb-4">
	                	<div class="card-header"><i class="fas fa-hammer"></i> Listado de Servicios</div>
	                	<div class="card shadow mb-12">
				            <div class="card-body">
				            	<div class="container-fluid">
