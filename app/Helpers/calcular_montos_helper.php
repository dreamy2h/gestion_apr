<?php
    function calcular_montos($lectura_anterior, $lectura_actual, $tope_subsidio, $datosCostoMetros, $cargo_fijo, $porcentaje, $total_servicios, $cuota_repactacion) {
        ...
        $total_mes = intval($monto_facturable) + intval($cuota_repactacion)  + intval($total_servicios);
